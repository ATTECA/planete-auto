...
export default function Page() {
  ...
  return (
    <main className="site-shell">
      ...
      <footer className="site-footer"><div className="footer-grid"><div className="footer-identity"><a href="#top" className="footer-brand"><img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Variation%20logo%20icon%20%282%29-lUSZ827J3zw81sV0WZTkV5kTx2WUjP.png" alt="" /><span>Planète <b>Auto</b></span></a><p>Véhicules d'occasion sélectionnés avec exigence.</p><span>SIREN : 799 787 262<br />SIRET : 799 787 262 00010</span><div className="socials" aria-label="Réseaux sociaux"><a href="#" aria-label="Instagram"><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="5" /><circle cx="12" cy="12" r="4" /><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none" /></svg></a><a href="#" aria-label="Facebook"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M14.2 21v-8h2.7l.4-3h-3.1V8.1c0-.9.3-1.5 1.6-1.5h1.7V4a22 22 0 0 0-2.5-.1c-2.5 0-4.2 1.5-4.2 4.3V10H8v3h2.8v8h3.4Z" fill="currentColor" stroke="none" /></svg></a></div></div><div className="footer-column"><h3>Navigation</h3><a href="#top">Accueil</a><a href="#stock">Nos véhicules</a><a href="/services">Services</a><a href="/reprise">Vendre mon véhicule</a></div><div className="footer-column footer-find"><h3>Nous trouver</h3><span><MapPin size={15} />2371 Route de Lavérune<br />34430 Saint-Jean-de-Védas</span><a href="tel:+33467825412"><Phone size={15} />04 67 82 54 12</a><a href="mailto:planeteauto34@gmail.com"><Mail size={15} />planeteauto34@gmail.com</a><a className="footer-map-link" href="https://www.google.com/maps/place/Plan%C3%A8te+autos/@43.5926281,3.8321068,18z" target="_blank" rel="noreferrer">Ouvrir dans Google Maps <ArrowRight size={14} /></a></div><div className="footer-column footer-hours"><h3>Horaires</h3><span><strong>Lundi–vendredi</strong><br />09h00–12h30 · 14h00–18h00</span><span><strong>Samedi</strong><br />10h00–17h00</span><span>Dimanche : fermé</span><div className="footer-map-frame"><iframe title="Planète Auto sur Google Maps" src="https://www.google.com/maps?q=43.5931637,3.8320012&z=16&output=embed" loading="lazy" /></div></div></div><div className="footer-bottom"><img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Variation%20logo%20icon%20%282%29-lUSZ827J3zw81sV0WZTkV5kTx2WUjP.png" alt="" /><span>Planète Auto © 2026 · SIRET 799 787 262 00010</span><a href="/mentions-legales">Mentions légales</a></div></footer>
    </main>
  )
}
