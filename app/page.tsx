...
export default function Page() {
  ...
  return (
    <main className="site-shell">
      ...
      <footer className="site-footer"><div className="footer-grid"><div className="footer-identity"><a href="#top" className="footer-brand"><img src={logo} alt="Planète Auto" /></a><p>Véhicules d'occasion sélectionnés avec exigence.</p><span>SIREN : 799 787 262<br />SIRET : 799 787 262 00010</span><div className="socials" aria-label="Réseaux sociaux"><span title="Instagram bientôt disponible"><Instagram size={16} /></span><span title="Facebook bientôt disponible"><Facebook size={16} /></span></div></div><div className="footer-column"><h3>Navigation</h3><a href="#top">Accueil</a><a href="#stock">Nos véhicules</a><a href="/services">Services</a><a href="/reprise">Vendre mon véhicule</a><a href="/mentions-legales">Mentions légales</a></div><div className="footer-column footer-find"><h3>Nous trouver</h3><span><MapPin size={15} />2371 Route de Lavérune<br />34430 Saint-Jean-de-Védas</span><a href="tel:+33467825412"><Phone size={15} />04 67 82 54 12</a><a href="mailto:planeteauto34@gmail.com"><Mail size={15} />planeteauto34@gmail.com</a><a className="footer-map-link" href="https://www.google.com/maps/place/Plan%C3%A8te+autos/@43.5926281,3.8321068,18z" target="_blank" rel="noreferrer">Ouvrir dans Google Maps <ArrowRight size={14} /></a></div><div className="footer-column footer-hours"><h3>Horaires</h3><span><strong>Lundi–vendredi</strong><br />09h00–12h30 · 14h00–18h00</span><span><strong>Samedi</strong><br />10h00–17h00</span><span>Dimanche : fermé</span><div className="footer-map-frame"><iframe title="Planète Auto sur Google Maps" src="https://www.google.com/maps?q=43.5931637,3.8320012&z=16&output=embed" loading="lazy" /></div></div></div><div className="footer-bottom"><span>Planète Auto © 2026 · SIRET 799 787 262 00010</span><a href="/mentions-legales">Mentions légales</a></div></footer>
    </main>
  )
}
