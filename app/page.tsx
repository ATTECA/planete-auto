...
export default function Page() {
  ...
  return (
    <main className="site-shell">
      ...
      <section className="dark-band" id="services"><div className="section dark-inner"><div className="dark-intro"><div className="eyebrow light"><span className="eyebrow-line" /> L'expérience Planète Auto</div><h2>Bien plus qu'une<br /><em>voiture.</em></h2><p>De la première rencontre jusqu'à la remise des clés, nous faisons de chaque étape un moment simple et serein.</p><a className="button button-light" href="/services">Découvrir nos services <ArrowRight size={17} /></a></div><div className="service-list"><ServiceCard number="01" icon={<CarFront />} title="Achat & vente" text="Des véhicules sélectionnés avec soin, contrôlés et préparés pour prendre la route." /><ServiceCard number="02" icon={<ShieldCheck />} title="Garantie 3 mois" text="Une garantie boîte et moteur, jusqu'à 5 000 km, pour démarrer en confiance." /><ServiceCard number="03" icon={<CarFront />} title="Reprise" text="Nous étudions votre véhicule et vous accompagnons vers votre prochain projet." /><ServiceCard number="04" icon={<ShieldCheck />} title="Financement" text="Des solutions claires et adaptées à votre budget, sans parcours compliqué." /></div></div><div className="service-approach"><div className="eyebrow"><span className="eyebrow-line" /> Une approche locale</div><h2>Le conseil avant<br /><em>la transaction.</em></h2><p>Planète Auto vous accompagne avec transparence, de la sélection du véhicule à la remise des clés.</p></div></section>
      ...
      <footer><a href="/mentions-legales">Mentions légales</a><a href="#top" className="footer-brand"><img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Variation%20logo%20icon%20%282%29-lUSZ827J3zw81sV0WZTkV5kTx2WUjP.png" alt="" /><span>Planète <b>Auto</b></span></a><span>© 2024 Planète Auto. L'automobile autrement.</span><a href="#contact">Nous contacter <ArrowRight size={15} /></a></footer>
    </main>
  )
}
